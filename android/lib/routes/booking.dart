        ...
        return (model.isOnline)
            ? Consumer<MovieServices>(
                builder: (_, movieCache, __) => FutureBuilder(
                    future: _bookService.movieSchedule(
                        movieCache.movie[movieCache.index].id.toString()),
                                ...
                                children: [
                                  ...
                                  Consumer<TicketServices>(
                                    builder: (_, ticketCache, __) =>
                                      ...
                                      onPressed: () async {
                                        int codeStatus =
                                            await cache.bookSeatNow(
                                          movieCache.movie[movieCache.index].id,
                                          movieCache
                                              .movie[movieCache.index].title,
                                          movieCache
                                        ...
                                        if (codeStatus == 1) {
                                          ...
                                          ticketCache.selSeats =
                                              cache.selectedSeats();
                                          ticketCache.movieTitle = movieCache
                                              .movie[movieCache.index].title;
                                          ticketCache.runtime = cache.selTime;
                                          ticketCache.movieImage = movieCache
                                              .movie[movieCache.index].image;
                                          ticketCache.movieGenre = movieCache
                                              .movie[movieCache.index].genre
                                              .split(",");
                                          ticketCache.ticketId = await cache
                                              .generateTicketId(movieCache
                                                  .movie[movieCache.index].id);
                                          ...
                                          showDialog(
                                              ...
                                              builder: (context) {
                                                return CustomAlertDialog(
                                                  title:
                                                      "Please check and choose wisely",
                                                  body:
